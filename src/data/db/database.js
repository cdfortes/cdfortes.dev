...
const database = {
  information: {
    name: 'Carlos Fortes',
    aboutContent:
      "I am a developer. I've been working as Developer (Backend, Frontend) since 2008 and currently (since 2016) at UTIC - Finance Ministry of Cabo Verde where I'm working with Liferay, ReactJS and other stuff.",
    age: 38,
    phone: '',
